...
group: layout
toc: true
permalink: /docs/4.3/layout/grid/
---
    ...
    <table class="table table-bordered table-striped">
      <thead>
        <tr>
          ...
          <th class="text-center"><div class="cell-inner">
            Small<br>
            <small>&ge;576px</small></div>
          </th>
          <th class="text-center"><div class="cell-inner">
            Medium<br>
            <small>&ge;768px</small></div>
          </th>
          <th class="text-center"><div class="cell-inner">
            Large<br>
            <small>&ge;1024px</small></div>
          </th>
          <th class="text-center"><div class="cell-inner">
            Extra large<br>
            <small>&ge;1280px</small></div>
          </th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <th class="text-nowrap" scope="row"><div class="cell-inner">Class prefix</div></th>
        ...
        <tr>
          <th class="text-nowrap" scope="row"><div class="cell-inner"># of columns</div></th>
          <td colspan="5"><div class="cell-inner">12</div></td>
        </tr>
        <tr>
          <th class="text-nowrap" scope="row"><div class="cell-inner">Gutter width</div></th>
          <td colspan="5"><div class="cell-inner">20px (10px on each side of a column)</div></td>
        </tr>
        <tr>
          <th class="text-nowrap" scope="row"><div class="cell-inner">Nestable</div></th>
          <td colspan="5"><div class="cell-inner">Yes</div></td>
        </tr>
        <tr>
          <th class="text-nowrap" scope="row"><div class="cell-inner">Column ordering</div></th>
          <td colspan="5"><div class="cell-inner">Yes</div></td>
        </tr>
      </tbody>
    </table>
