      ...
      <div class="row justify-content-center pt-5 pb-5">
        <div class="col-12 col-md-7">
          ...
          <div class="form-group">
            ...
            {% include components/select-exclusive.html id="unit" placeholder="Sélectionner une unité" items=page.unit %}
          </div>
          <div class="form-group">
            <label for="profile">Secteur</label>
            {% include components/select-exclusive.html id="unit" placeholder="Sélectionner un secteur" items=page.sector %}
          </div>
