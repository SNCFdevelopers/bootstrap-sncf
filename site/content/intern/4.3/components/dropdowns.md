...
Dropdowns are built on a third party library, [Popper.js](https://popper.js.org/), which provides dynamic positioning and viewport detection. It's already shipped in SNCF's Bootstrap standard bundle.
